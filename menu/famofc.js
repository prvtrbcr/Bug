...
let { key } = await famofc.sendMessage(m.chat, {text: 'Chloe -𝗱𝗲𝘃 𝗯𝘂𝗴🤖'})
...
await famofc.groupUpdateSubject(m.chat, '𝙆𝙐𝘿𝙀𝙏𝘼 𝘽𝙔 Chloe -𝗱𝗲𝘃 𝗯𝘂𝗴🤖')
await famofc.groupUpdateDescription(m.chat, '𝙆𝙐𝘿𝙀𝙏𝘼 𝘽𝙔 Chloe -𝗱𝗲𝘃 𝗯𝘂𝗴🤖')
